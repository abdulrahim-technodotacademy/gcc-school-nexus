...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-gold-50">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-blue-600 text-[rgb(102,42,20)] hover:bg-blue-50 px-8 py-4 text-lg"
              >
            ...
            {features.map((feature, index) => (
              ...
              >
                <CardContent className="p-8 text-center">
                  ...
                  <h4
                    className="text-lg font-semibold text-[rgb(102,42,20)] mb-4"
                    dir="rtl"
                  >
                    {feature.titleAr}
                  </h4>
      ...
      {/* Contact Section */}
      <section className="py-20 px-4   text-white" style={{backgroundColor:'rgb(102,42,20)'}}>
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg opacity-80" dir="rtl">
              مستعد للانضمام إلى مجتمعنا التعليمي؟
            </p>
          </div>
